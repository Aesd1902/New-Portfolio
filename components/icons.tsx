...
export const BriefcaseIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.92a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.92-1.75l.93-.65a2.25 2.25 0 001.32-.42l.33-.23a2.25 2.25 0 012.66 0l.33.23a2.25 2.25 0 001.32.42l.93.65a2.25 2.25 0 01.92 1.75z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 8.25V5.25a2.25 2.25 0 00-2.25-2.25H8.25A2.25 2.25 0 006 5.25v3M12 11.25a.75.75 0 000 1.5h.008a.75.75 0 000-1.5H12z" />
  </svg>
);
...
export const PortfolioIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
